  ...
  return (
    <div style={{ padding: '20px', fontFamily: 'Arial', backgroundColor: '#121212', color: 'white', minHeight: '100vh' }}>
      <header style={{ textAlign: 'center', marginBottom: '40px' }}>
        <h1 style={{ fontSize: '3rem', color: '#1DB954' }}>SUBTE</h1>
      ...
      <form onSubmit={buscarMusica} style={{ maxWidth: '600px', margin: '0 auto', textAlign: 'center' }}>
        ...
        <button 
          type="submit" 
          disabled={cargando}
          style={{ padding: '15px 30px', backgroundColor: '#1DB954', color: 'white', border: 'none', borderRadius: '30px', cursor: 'pointer', fontWeight: 'bold' }}
        >
